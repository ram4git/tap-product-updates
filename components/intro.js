  ...
  return (
    <section className="flex-col md:flex-row flex items-center md:justify-between mt-16 mb-16 md:mb-12 mx-auto">
      <div className="mx-auto justify-center flex flex-col items-center">
        ...
        <p className="text-center text-4xl md:text-6xl font-bold tracking-tighter leading-tight bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">
          Product Updates
        </p>
      </div>
    </section>
